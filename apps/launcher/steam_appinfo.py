...
def iter_appinfo(data: bytes) -> Iterator[dict[str, Any]]:
    ...
    while pos + 4 <= table_offset:
        ...
        yield {
            ...
            "has_adult_content": bool(common.get("has_adult_content")),
            "has_adult_content_sex": bool(common.get("has_adult_content_sex")),
            "has_adult_content_violence": bool(common.get("has_adult_content_violence")),
