@tool
class_name GodotxToastStyle
extends Resource

@export_group("Background")
@export var background_type: GodotxToastEnums.BackgroundType = GodotxToastEnums.BackgroundType.COLOR
...
@export var spinner_type: GodotxToastEnums.SpinnerType = GodotxToastEnums.SpinnerType.NONE
...
@export var stack_strategy: GodotxToastEnums.StackStrategy = GodotxToastEnums.StackStrategy.REPLACE_OLDEST
...
@export var swipe_direction: GodotxToastEnums.SwipeDirection = GodotxToastEnums.SwipeDirection.HORIZONTAL
...
@export var default_animation: GodotxToastEnums.ToastAnimation = GodotxToastEnums.ToastAnimation.SLIDE
...
@export_group("Spawn")
@export var default_origin: GodotxToastEnums.ToastOrigin = GodotxToastEnums.ToastOrigin.BOTTOM
