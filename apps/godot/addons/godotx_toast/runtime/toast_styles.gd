...
static var _default_font_path: String = "res://addons/godotx_toast/assets/fonts/Roboto-Regular.ttf"
...
static func _register_builtin_styles() -> void:
	...
	success.default_origin = GodotxToastEnums.ToastOrigin.BOTTOM
	...
	warning.default_origin = GodotxToastEnums.ToastOrigin.BOTTOM
	...
	info.default_origin = GodotxToastEnums.ToastOrigin.BOTTOM
	register(INFO, info)
	...
	error.default_origin = GodotxToastEnums.ToastOrigin.BOTTOM
	...
	light.default_origin = GodotxToastEnums.ToastOrigin.BOTTOM
	...
	dark.default_origin = GodotxToastEnums.ToastOrigin.BOTTOM
	register(DARK, dark)
	...
	loading.default_origin = GodotxToastEnums.ToastOrigin.BOTTOM
